...
const MODE_CONFIGS: Record<LifestyleMode, LifestyleModeConfig> = {
  morning: {
    ...
    subline: "Frühstück, Kaffee, Work-Spots — die besten Cafés in Wien warten auf Sie.",
  ...
  lunch: {
    ...
    subline: "Mittagspause in Wien — schnelle Gerichte, Top-bewertet. Ihr Lieblingslokal ist dabei.",
  ...
  afternoon: {
    ...
    subline: "Kaffee, Kuchen, gemütliche Nachmittagsplätze in Wien — laden Sie Ihre Energie auf.",
  ...
  evening: {
    ...
    subline: "Abendessen, Cocktails, Chill-Spots in Wien — machen Sie den Abend unvergesslich.",
  ...
  night: {
    ...
    headline: "Die Nacht\ngehört Ihnen",
    subline: "Bars, Nightlife, Happy Hour — erleben Sie Wien nach Einbruch der Dunkelheit.",
